    ...
    <div class="md:flex md:justify-center">
        <div class="md:w-1/2 bg-white shadow">
            <form action="{{ route('profile.store') }}" enctype="multipart/form-data" method="post" class="mt-10 md:mt-0">
                ...
                <input type="submit" value="Update profile" class="bg-sky-600 hover:bg-sky-700 transition-colors cursor-pointer uppercase font-bold w-full p-3 text-white rounded-lg">
            </form>
        </div>
    </div>
@endsection